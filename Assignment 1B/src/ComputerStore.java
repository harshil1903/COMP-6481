...
//class Driver
//{
//	public static int passwordCount = 1;
//	
//	
//	
...
//			Scanner sc = new Scanner(System.in);
//			userChoice = sc.nextInt();
//		} while (!(userChoice > 0 && userChoice < 6) && (userChoice == (int) userChoice));
//		switch (userChoice) {
//			case 1:
//				//Enter Password, then computer details
//				passwordDetais();
//				break;
//			case 2:
//				//Enter Password, then edit computer info
//				passwordDetais();
//				break;
//			case 3:
//				//Display Computers by brand
//				break;
//			case 4:
//				//Display computers by price
//				break;
//			case 5:
//				//exit
//				break;
...
//		Scanner sc = new Scanner(System.in);
//		
//		String brand_name = null, model = null, serial_number = null;
//		double price = 0;
//		
//		int num_com = Integer.parseInt(sc.next());
//		for (int i = 0; i < num_com; i++) {
//			System.out.println("Enter Brand of Computer");
...
//			price = sc.nextDouble();
//			
//			Computer c = new Computer(brand_name, model, serial_number, price);
//		}
//		
//		
//	}
